...
public class I_Common {
	...
	public static By div_ErrorMessage = By.xpath("//div[contains(@class,'snotify snotify-rightBottom')]/ng-snotify-toast");
	...
	public static By div_generalDropdown = By.xpath("//ng-dropdown-panel/div/div[2]");
